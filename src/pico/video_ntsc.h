...
typedef struct {
    ...
    uint64_t irq0_count;
    uint64_t irq1_count;
    uint64_t lines_rendered;
    uint64_t vsync_lines_rendered;
    uint64_t blank_lines_rendered;
    uint64_t active_lines_rendered;
    uint64_t render_us_total;
    uint32_t render_us_max;
    uint32_t render_over_50us_count;
    uint32_t render_over_63us_count;
    uint32_t render_over_100us_count;
    uint32_t render_us_max_line;
    uint32_t render_us_max_active_y;
    uint32_t render_us_max_kind;
    uint32_t display_line;
    uint32_t render_line;
    uint32_t idle_buf;
    uint32_t queue_level;
    uint32_t queue_level_max;
    uint32_t queue_producer_stall_count;
    uint64_t queue_producer_stall_us_total;

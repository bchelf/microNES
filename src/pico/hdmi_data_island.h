 ...
 * + N packets (32 px each) + trailing guard band (2 px). Returns the number
 * of RAW words written (= 12 + 32*npackets). All emitted as a single
 * continuous HSTX_CMD_RAW stream — this layout successfully triggered HDMI
 * mode detection during bring-up.
 */
